<template>
  <span
    :class="[
      rotateDeg,
      props.hours < 11 && props.hours > 0 ? 'transition-all' : '',
    ]"
    class="absolute top-[50%] w-1/2 h-0.5 before:absolute before:right-0 before:w-14 before:h-full before:bg-neutral-300 before:rounded-full z-10"></span>
</template>
